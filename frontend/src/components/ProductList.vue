<template>
  <div class="product-list-container">
    ...
    <el-card class="filter-card" shadow="never">
      <el-form :inline="true" :model="queryParams" @submit.prevent="handleSearch">
        <el-form-item label="状态">
          <el-select v-model="queryParams.isValid" placeholder="全部" clearable style="width: 120px;">
            <el-option label="有效" :value="1" />
            <el-option label="失效" :value="0" />
          </el-select>
        </el-form-item>
        <el-form-item label="确认状态">
          <el-select v-model="queryParams.confirmStatus" placeholder="全部" clearable style="width: 120px;">
            <el-option label="待处理" :value="0" />
            <el-option label="已确认" :value="1" />
          </el-select>
        </el-form-item>
        <el-form-item label="销售地区">
          <el-input v-model="queryParams.saleRegion" placeholder="如: IDR" clearable style="width: 120px;" />
        </el-form-item>
        <el-form-item label="商品ID">
          <el-input v-model="queryParams.keyword" placeholder="搜索商品ID" clearable style="width: 200px;" />
        </el-form-item>
        <el-form-item>
    ...
    <el-card class="table-card" shadow="never">
      ...
      >
        <el-table-column prop="productId" label="商品ID" width="180" fixed />
        <el-table-column prop="title" label="商品标题" min-width="250" show-overflow-tooltip />
        <el-table-column prop="shopName" label="店铺名称" width="150" show-overflow-tooltip />
        <el-table-column prop="saleRegion" label="销售地区" width="100" align="center" />
        <el-table-column prop="isValid" label="状态" width="100" align="center">
        ...
        <el-table-column label="佣金信息" width="220">
          <template #default="{ row }">
        ...
        <el-table-column prop="lastCheckTime" label="最后校验时间" width="170" />
